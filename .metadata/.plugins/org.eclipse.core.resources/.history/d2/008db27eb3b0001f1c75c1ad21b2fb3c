...
public class Form_NhaCungCap extends JPanel {
    ...
    private JPanel createTopPanel() {
        ...
        configureButtonWithPermission(addButton, currentUserId, PermissionChecker.PERM_PRODUCT_MANAGEMENT, this::showAddDialog);

        // Edit Button
        JButton editButton = createRoundedButton("Sửa", "/icon/pencil.png", true);
        configureButtonWithPermission(editButton, currentUserId, PermissionChecker.PERM_PRODUCT_MANAGEMENT, this::showEditDialog);

        // Delete Button
        JButton deleteButton = createRoundedButton("Xóa", "/icon/trash.png", true);
        configureButtonWithPermission(deleteButton, currentUserId, PermissionChecker.PERM_PRODUCT_MANAGEMENT, this::deleteSupplier);

        // Info Button
        JButton aboutButton = createRoundedButton("Giới thiệu", "/icon/info.png", true);
        configureButtonWithPermission(aboutButton, currentUserId, PermissionChecker.PERM_PRODUCT_MANAGEMENT, this::showAboutDialog);
    ...
    private void showAddDialog() {
        ...
        saveButton.addActionListener(e -> {
            ...
            String maNhaCC = "SUP" + String.format("%03d", tableModel.getRowCount() + 1);
