...
public class XemChiTietPhanLoai extends JDialog {
    ...
    private void initComponents() {
        ...
        JPanel rightButtonPanel = new JPanel(new GridLayout(4, 1, 0, 5));
        ...
        // Fetch product variants from the database using the productID
        ProductVariantBUS variantBUS = new ProductVariantBUS();
        java.util.List<ProductVariant> variants = variantBUS.getAllVariantsByProductID(maSP);
